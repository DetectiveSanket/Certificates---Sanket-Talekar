...
- 🤖 **AI & Automation**: Generative Al, LangChain, LangGraph, n8n, RAG, LLM, NLP, MCP, LLM Fine-tuning, Agentic RAG, Context Engineering, Prompt Engineering, Al Agents, Multi-Agent System, LLM Evaluation, Gemini API
